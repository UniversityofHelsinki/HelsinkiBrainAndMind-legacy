...
namespace Drupal\bnm_import\Plugin\Field\FieldType;
 ...
 * @FieldType(
 *   id = "bnm_csv_import",
 *   label = @Translation("Bnm - Csv import"),
 *   description = @Translation("Save csv field and import content."),
 *   category = @Translation("Reference"),
 *   default_widget = "bnm_csv_file_widget",
 *   default_formatter = "bnm_csv_file_formatter",
